...
{      			    
    ...
    else if (size==32) temp = Hzk[chr][t];  //调用汉字字体 	 
		else temp = dummy[0][t];
        for(t1=0;t1<8;t1++)
		{
...
void OLED_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3|GPIO_Pin_4|GPIO_Pin_5|GPIO_Pin_6|GPIO_Pin_7;	 //PA3-7推挽输出  
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;  //速度50MHz
 	GPIO_Init(GPIOA, &GPIO_InitStructure);
	
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0;  //PB0推挽输出  
